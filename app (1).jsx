...
function LoginScreen({ onAuth }) {
  ...
  const handleSubmit = () => {
    ...
    if (trimmed === APP_PASSWORD) { onAuth(); }
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0e17", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: F, color: "#f9fafb" }}>
      ...
      <div style={{ background: "#111827", borderRadius: 14, padding: 28, width: 340, border: "1px solid #1f2937" }}>
        <p style={{ fontSize: 15, fontWeight: 600, marginBottom: 16, textAlign: "center", color: "#f9fafb" }}>Enter Password</p>
        <input type="text" autoComplete="off" value={pw} onChange={function(e) { setPw(e.target.value); setErr(false); }}
          onKeyDown={function(e) { if (e.key === "Enter") handleSubmit(); }}
          placeholder="Password"
          style={{ width: "100%", padding: "10px 14px", borderRadius: 8, border: err ? "1px solid #ef4444" : "1px solid #374151", background: "#0d1117", color: "#f9fafb", fontSize: 14, fontFamily: F, outline: "none", boxSizing: "border-box", marginBottom: 12, WebkitTextSecurity: "disc" }}
          autoFocus
        />
